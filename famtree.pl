/*
  ...
  where the relation will be the mother or father or so on. To execute
  query use -
  parent(ellie, X).
  married (X, sophia).
  father(sophia, X). and so on...
...
parent(charlie, jimmy).

parent(ellie, jimmy).

parent(charles, charlie).

parent(cinni, charlie).
...
parent(charles, fannie).

parent(james, fannie).

parent(sophia, paul).

parent(ellie,claudia).

parent(charlie, claudia).


/* married ( A,B)  - A is married to B */

married( jimmy, claudia).

married( claudia, jimmy).

married(charlie, fannie).

married(fannie, charlie).
...
/* Auntie is the aunt of Kid if she is female and a sister of the kid's parent or
  ...
  she is female and married to the kid's uncle. This is the definition
  of an Aunt as given by dictinoary.com :
...
/* Unclebuck is the uncle of Kid if he is male and a brother of the kid's parent or he is male and married to the kid's aunt. This is the definition of an Aunt as given by dictinoary.com :
...
/* Grandfather is the grandfather of GrandChild if he is male and the parent of the child's parent james */
